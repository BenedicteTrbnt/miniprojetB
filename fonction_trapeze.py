...
def mesurer_temps_integral(a,b,n,p1,p2,p3,p4,fonction): #calcul de temps d'excution
    temps_math = timeit.timeit(lambda: trapeze_math(a,b,n,p1,p2,p3,p4,fonction), number=n)
    resultat_math = trapeze_math(a,b,n,p1,p2,p3,p4,fonction)
    temps_numpy = timeit.timeit(lambda: trapeze_numpy(a,b,n,p1,p2,p3,p4,fonction), number=n)
